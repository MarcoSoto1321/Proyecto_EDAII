...
if __name__ == '__main__':
    ...
    arbol = crear_arbol(lista_de_productos)
    total = total_de_compra(arbol)
    print(f'Total de compra: {total}')
    escribir_productos(lista_de_productos, 'Lista 1')
    lista_para_el_usuario(arbol, lista_de_productos)